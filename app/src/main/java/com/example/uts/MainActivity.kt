...
class MainActivity : AppCompatActivity() {
    ...
    val email = "mbintangr13@gmail.com"
    val password = "12345"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        saveUserData(email, "2207411055", "Muhammad Bintang Ramadhan", "TI 4B")
    ...
    private fun saveUserData(email: String, nim: String, nama: String, kelas: String) {
