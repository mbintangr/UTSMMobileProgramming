...
class AlumniDetailsActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnEditData.setOnClickListener {
            ...
            dbHelper.editAlumniByNim(nim, nama, tempatLahir, tanggalLahir, alamat, agama, noTelp, tahunMasuk, tahunLulus, pekerjaan, jabatan)
            finish()
        }

        val btnDeleteData = findViewById<Button>(R.id.btnDeleteData)
        btnDeleteData.setOnClickListener {
            dbHelper.deleteAlumniByNim(nim)
            finish()
        }
    }
